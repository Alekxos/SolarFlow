...
if __name__ == '__main__':
     ...
     fig, ax = plt.subplots()
     selected_frequencies = unique_frequencies[-14:-1]
     ...
     plt.savefig('/Users/minerva/Lab/SolarFlow/output/circle_fits.png', bbox_inches='tight')
     ...
     plt.savefig('/Users/minerva/Lab/SolarFlow/output/theta_vs_voltage.png', bbox_inches='tight')

     # Plot circle radius as a function of frequency.
     fig, ax = plt.subplots()
     plot_omega_vs_radius(selected_frequencies, circle_fits, axis=ax)
     plt.savefig('/Users/minerva/Lab/SolarFlow/output/radius_vs_omega.png', bbox_inches='tight')
